					...
					<div class="about-block">
						<div class="container">
							<h2 class="text-left text-uppercase font-italic">
								<?php the_field('caption-about-1', 62); ?></h2>
							<h1 class="text-left text-uppercase"><?php the_field('caption-about-2', 62); ?></h1>
							<p class="text-left">
								<?php the_field('text-about-1', 62); ?>
							</p>
							<p class="text-left">
								<?php the_field('text-about-2', 62); ?>
							</p>
							<table class="table table-about">
							  <tbody>
							    <tr>
							      <td><?php the_field('text-table', 62); ?></td>
							      <td><?php the_field('text-table', 62); ?></td>
							    </tr>
							    <tr>
							      <td><?php the_field('text-table', 62); ?></td>
					...
					<div class="container">
						<div class="row">
							<div class="col-5 offset-7">
								<div class="work">
									<h2 class="text-left text-uppercase font-italic"><?php the_field('Caption-service1', 62); ?></h2>
									<h1 class="text-left text-uppercase"><?php the_field('Caption-service2', 62); ?></h1>
									<p class="text-left">
										<?php the_field('Text-service1', 62); ?>
									</p>
									<span class="text-left font-italic text-lowercase read-more">
										<?php the_field('Text-service2', 62); ?>
									</span>
							</div>
						</div>
						<div class="col-7">
								...
								<div class="container">
										...
										<div class="col-9">
											<div class="features-one">
												<h2 class="text-left text-uppercase">
													<?php the_field('caption-features-one', 62); ?>
												</h2>
												<p class="text-left">
													<?php the_field('text-features-one', 62); ?>
												</p>
											</div>
										</div>
									</div>
									<div class="row">
										...
										<div class="col-9">
											<div class="features-one">
												<h2 class="text-left text-uppercase">
													<?php the_field('caption-features-two', 62); ?>
												</h2>
												<p class="text-left">
													<?php the_field('text-features-two', 62); ?>
												</p>
											</div>
										</div>
									</div>
									<div class="row">
										...
										<div class="col-9">
											<div class="features-one">
												<h2 class="text-left text-uppercase">
													<?php the_field('caption-features-three', 62); ?>
												</h2>
												<p class="text-left">
													<?php the_field('text-features-three', 62); ?>
												</p>
											</div>
										</div>
									</div>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-4">
				<div class="team-info">
					<h2 class="text-left text-uppercase font-italic">
						<?php the_field('caption-team1', 62); ?>
					</h2>
					<h1 class="text-left text-uppercase">
						<?php the_field('caption-team2', 62); ?>
					</h1>
					<p class="text-left">
						<?php the_field('text-team', 62); ?>
					</p>
				</div>
			</div>
			<div class="col-8">
	        ...
	        <div class="thumb thumb-one">
	          <a class="fancybox" data-fancybox="group" data-type="image" data-caption="субтитр-1" href="<?php bloginfo('template_url'); ?>/assets/images/square.jpg" title="картинка">
	          	<img class="img-responsive" src="<?php the_field('square', 62); ?>" alt="Foto" height="500px">
	          </a>
	        </div>
			...
			<div class="col-12">
				<div class="reviews-top">
					<h2 class="text-center text-uppercase">
						<?php the_field('caption-people1', 62); ?>
					</h2>
					<h1 class="text-center text-uppercase">
						<?php the_field('caption-people2', 62); ?>
					</h1>
				</div>
			</div>
		</div>
				...
				<div class="reviews-bottom">
					<div class="row">
						<div class="col-2">
						    ...
						    <img src="<?php the_field('quotes1', 62); ?>" alt="quotes-1">
							</div>
						</div>
						<div class="col-2 offset-8">
							<div class="reviews-middle quotes-2 text-left align-text-bottom">
						  <img src="<?php the_field('quotes2', 62); ?>" alt="quotes-2">
							</div>
						</div>
					</div>
					<p class="citation text-center font-italic">
						<?php the_field('text-people1', 62); ?>
					</p>
					<p class="sign text-center text-uppercase">
						<?php the_field('text-people2', 62); ?>
					</p>
				</div>
			</div>
		</div>
			...
			<div class="col-4">
				<div class="gallary-info">
					<h2 class="text-uppercase font-italic">
						<?php the_field('caption-gallary1', 62); ?>
					</h2>
					<h1 class="text-uppercase">
						<?php the_field('caption-gallary2', 62); ?>
					</h1>
					<p>
						<?php the_field('text-gallary', 62); ?>
					</p>
				</div>
			</div>
		</div>
